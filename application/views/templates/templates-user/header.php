        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link active" href="<?= base_url(); ?>"><i class="fas fw fa-home"></i> Beranda<span class="sronly"></span></a>
                    ...
                    <?php } else { ?>
                        ...
                        <a class="nav-item nav-link" data-toggle="modal" datatarget="#daftarModal" href="#"><i class="fas fw fa-user"></i> Daftar</a>
