        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link active" href="<?= base_url(); ?>"><i class="fas fw fa-home"></i> Beranda<span class="sr-only"></span></a>
                    
                    <?php
                    if (!empty($this->session->userdata('email'))) { ?>
                        <a class="nav-item nav-link" href="<?= base_url('booking'); ?> "> <i class="far fw fa-shopping-cart"></i> Booking Buku </a>
                        <a class="nav-item nav-link" href="<?= base_url('member/myprofil'); ?>"><i class="far fw fa-address-cart"></i> Profil Saya</a>
                        <a class="nav-item nav-link" href="<?= base_url('member/logout'); ?>"><i class="fas fw fa-login"></i> Log out</a>
                    <?php } else { ?>

                        <a class="nav-item nav-link" data-toggle="modal" data-target="#daftarModal" href="#"><i class="fas fw fa-user"></i> Daftar</a>
